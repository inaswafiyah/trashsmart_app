...
class BankResponseModel {
  ...
  BankResponseModel({this.message, this.data});

  factory BankResponseModel.fromJson(String str) =>
      BankResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory BankResponseModel.fromMap(Map<String, dynamic> json) =>
      BankResponseModel(

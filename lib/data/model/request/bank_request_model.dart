...
class BankRequestModel {
    ...
    factory BankRequestModel.fromJson(String str) => BankRequestModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory BankRequestModel.fromMap(Map<String, dynamic> json) => BankRequestModel(
